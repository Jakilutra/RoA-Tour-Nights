...
=IFS(
        ...
        SUMPRODUCT(REGEXMATCH(OFFSET($T$3,20,0):OFFSET($T$1976,-2,0),"https:\/\/www\.smogon\.com\/forums\/threads\/roa-tour-nights\.3615570\/post-\d+"))<(REGEXEXTRACT(T4,"\d+")-18), "Warning: Wrong Post URL format detected. You may need to remove `page-#` from your URL.",
